...
class TrimView(ctk.CTkFrame):
    ...
    def setup_ui(self):
        # --- Header ---
        self.header_label = ctk.CTkLabel(self, text="Trim Audio", font=("Roboto", 24, "bold"))
    ...
    def add_range_row(self):
        ...
        self.range_rows.append({"frame": row_frame, "start": start_input, "end": end_input})
    ...
    def start_processing_thread(self, is_preview=False):
        ...
        self.progress_bar.set(0)
        self.status_label.configure(text="Generating Preview..." if is_preview else "Processing & Saving...", text_color="#3B8ED0")
    ...
    def run_processing(self, ranges, is_preview):
        try:
            ...
            self.processor.process_audio(self.selected_file_path, output_path, ranges, progress_callback=self.update_progress)
...
class SpeedView(ctk.CTkFrame):
    ...
    def setup_ui(self):
        # Header
        ctk.CTkLabel(self, text="Speed Control", font=("Roboto", 24, "bold")).grid(row=0, column=0, padx=20, pady=(20, 10))
        ...
        self.slider = ctk.CTkSlider(self.slider_frame, from_=0.5, to=2.0, number_of_steps=30, variable=self.speed_var, command=self.update_label)
        ...
        # Action
        self.process_btn = ctk.CTkButton(self, text="Process & Save Speed", command=self.on_process, height=40, font=("Roboto", 14, "bold"))
    ...
    def run_processing(self):
        try:
            ...
            self.processor.change_speed(self.selected_file_path, output_path, float(self.speed_var.get()))
...
class AudioTrimmerApp(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        self.logo_label = ctk.CTkLabel(self.sidebar_frame, text="TrimToFit", font=("Roboto", 20, "bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))
        
        self.trim_btn = ctk.CTkButton(self.sidebar_frame, text="✂️ Audio Trimmer", command=self.select_trim_view, 
        ...
        self.speed_btn = ctk.CTkButton(self.sidebar_frame, text="⏩ Speed Control", command=self.select_speed_view,
                                       fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), anchor="w")
    ...
    def create_content_area(self):
        ...
        # Instantiate views
        self.trim_view = TrimView(self.content_frame, self.processor, fg_color="transparent")
        self.speed_view = SpeedView(self.content_frame, self.processor, fg_color="transparent")
